...
const screens = {
    ...
    profile: `
        ...
        <div style="padding: 6rem 1.5rem 2rem; max-width: 800px; margin: 0 auto; text-align: center;">
            <div style="width: 100px; height: 100px; border-radius: 50%; background: var(--color-surface-container-low); margin: 0 auto 1rem; display: flex; align-items: center; justify-content: center; font-size: 3rem;">
                <i class="fas fa-user"></i>
            </div>
            ...
            <div class="card">
                ...
                <div style="background: rgba(163, 56, 24, 0.1); padding: 1rem; border-radius: 0.75rem; border-left: 4px solid var(--color-primary); margin-bottom: 1rem;">
                    <h4 style="font-weight: 700; margin-bottom: 0.5rem;">
                        Pièce d'Identité 
                        <span style="background: var(--color-surface-container); color: var(--color-on-surface-variant); padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-size: 0.75rem; font-weight: 600;">Étape 1</span>
                    </h4>
